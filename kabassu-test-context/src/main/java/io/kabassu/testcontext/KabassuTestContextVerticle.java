...
import io.kabassu.testcontext.configuration.KabassuTestComtextConfiguration;
...
public class KabassuTestContextVerticle extends AbstractVerticle {
  ...
  private KabassuTestComtextConfiguration configuration;

  @Override
  public void init(Vertx vertx, Context context) {
    super.init(vertx, context);
    configuration = new KabassuTestComtextConfiguration(config());
  }
