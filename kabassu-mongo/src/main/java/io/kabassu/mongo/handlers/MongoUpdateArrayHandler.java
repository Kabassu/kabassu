...
public class MongoUpdateArrayHandler extends AbstractUpdateMongoHandler<JsonObject> {
  ...
  public void handle(Message<JsonObject> event) {
    ...
    client.findOneAndUpdate(request.getString(JsonFields.COLLECTION),
      new JsonObject().put("_id", request.getString("id")),
      new JsonObject().put(OPERATION_MAP.get(request.getString("operation")), new JsonObject()
        .put(request.getString("field"), request.getString("value"))),
